...
This is in fact a somewhat modified version of the Python
interface to Snack:
It imports Snack from a specific directory instead of
the main Tcl folder (Marton Soskuthy, 16/06/2013)

Note that the current version has not been adapted
to Windows (and likely won't work with it!)
